...
plt.ion() # Turns on interactive mode for MATLAB plots, so that plot is showed without use of plt.show()
...
env = gym.make('FrozenLake-v1', render_mode="rgb_array", is_slippery=False) # Initialises environment
...
num_episodes = 2000 if torch.cuda.is_available() or torch.backends.mps.is_available() else 1000
